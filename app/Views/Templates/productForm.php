<section>
    <h1 class="text-center text-capitalize">New Product</h1>
    <div class="container">
         <form method="post" action="<?php echo base_url(); ?>/AddProduct" id="application-form" enctype="multipart/form-data">
            <div class="form-group">
                <div class="form-row">
                    <div class="col">
                        <p><strong>Product Code</strong><span class="text-danger">*</span></p><input class="form-control" type="text" required name="code"/>
                    </div>
                    <div class="col">
                        <p><strong>Category</strong></p><input class="form-control" type="text" required name="category"/>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-row">
                    <div class="col">
                        <p><strong>Description</strong><span class="text-danger">*</span></p><input class="form-control" type="text" required name="description" />
                    </div>
                </div>
            </div>
            <div class="form-group">
                <p><strong>Supplier </strong><span class="text-danger">*</span></p><input class="form-control" type="text" name="supplier" />
            </div>
            <div class="form-group">
                <p><strong>Bulk Buy Price </strong><span class="text-danger">*</span></p><input class="form-control" type="number" name="buy" />
            </div>
            <div class="form-group">
                <p><strong>Bulk Sale Price </strong><span class="text-danger">*</span></p><input class="form-control" type="number" required name="sale" />
            </div>
            <div class="form-group">
                <div>
